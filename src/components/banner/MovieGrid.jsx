    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 mt-8">
      {results.map((item, i) => {
        ...
        return (
          ...
          >
            <div className="relative aspect-[2/3] rounded-xl overflow-hidden bg-white/5 ring-1 ring-white/10 group-hover:ring-amber-500/50 transition-all duration-300">
              {poster ? (
